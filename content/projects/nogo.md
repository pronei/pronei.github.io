...
title: nogo
weight: 5
summary: A lightweight, rules-driven rate limiter — the open-source descendant of the notification gate I built at MakeMyTrip.
stack: [Go]
metrics:
...
went up while infra cost went down ([numbers on the CV](/cv/)), because the cheapest
notification is the one you don't send.
